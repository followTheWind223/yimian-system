-- ============================================================
-- 13-fix-permissions.sql
-- 补全 knowledge 和 tag 相关权限，确保 sys_role_permission 关联完整
-- 执行: mysql -u root -p1234 --default-character-set=utf8mb4 yimian < 13-fix-permissions.sql
-- ============================================================
...
-- ============================================================
-- 3. 将 knowledge 相关权限分配给 ROLE_USER 和 ROLE_ADMIN
-- ============================================================
...
-- ============================================================
SELECT '=== 权限表 ===' AS '';
SELECT id, perm_code, perm_name FROM sys_permission WHERE perm_code LIKE 'knowledge:%' OR perm_code LIKE 'tag:%' ORDER BY id;
